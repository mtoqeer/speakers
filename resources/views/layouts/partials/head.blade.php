    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('websiteassests/img/logo/favicon.png')}}">

    <!-- all css here -->
    <link rel="stylesheet" href="{{asset('websiteassests/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('websiteassests/css/animate.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('websiteassests/css/style.css?v=10')}}">
